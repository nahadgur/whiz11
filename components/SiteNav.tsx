...
export const SUBJECTS = [
  ...
  },
  {
    ...
    desc: 'Logic, codes & word relationships',
  ...
  },
  {
    ...
    desc: 'Patterns, matrices & spatial thinking',
...
interface SiteNavProps {
  /** Optional: highlight the CTA differently (e.g. on landing page it says "Get Started", elsewhere "Try Free") */
  ctaLabel?: string;
  /** Optional: href for the CTA — defaults to "/" (the app) */
  ctaHref?: string;
}
...
// ─── LeadGenModal (shared across all pages) ───────────────────────────────────

import {
  Mail, Phone, User, Calendar, Lock, X, Rocket, ArrowRight,
} from 'lucide-react';
...
export const LeadGenModal = ({
  ...
  const [formData, setFormData] = React.useState({
    email: '', phone: '', childName: '', childYear: '',
  });
